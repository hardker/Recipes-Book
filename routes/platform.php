...
use App\Orchid\Screens\UserLog\UserLogListScreen;
/*
|--------------------------------------------------------------------------
| Dashboard Routes
|--------------------------------------------------------------------------
...
//Route::screen('recipes', RecipeListScreen::class) ->name('platform.recipes');
...
Route::screen('recipes', RecipeListScreen::class)
    ...
    ->breadcrumbs(fn (Trail $trail) => $trail
        ->parent('platform.index')
        ->push('Рецепты', route('platform.recipes')));
...
Route::screen('categories', CategoryListScreen::class)
    ...
    ->breadcrumbs(fn (Trail $trail) => $trail
        ->parent('platform.index')
        ->push('Категории', route('platform.categories')));
...
Route::screen('categories/{category}/edit', CategoryEditScreen::class)
    ...
    ->breadcrumbs(fn (Trail $trail, $category) => $trail
        ...
        ->push($category->name_cat, route('platform.categories.edit', $category)));
...
// Platform > System > UserLog
Route::screen('userlogs', UserLogListScreen::class)
    ->name('platform.systems.userlogs')
    ->breadcrumbs(fn (Trail $trail) => $trail
        ->parent('platform.index')
        ->push(('Статистика активности'), route('platform.systems.userlogs')));

// Analytics
Route::screen('analitics', AnalyticsScreen::class)
    ->name('platform.analitics')
    ->breadcrumbs(fn (Trail $trail) => $trail
        ->parent('platform.index')
        ->push('Аналитика'));
