            ...
            <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('recipe.add') }}"
                ...
                <div class="form-group">
                    ...
                    <div class="row justify-content-start">
                        <div class="col-lg-6 form-group">
                            <label for="category_id" class="h4 form-label">Категория рецепта<span
                        ...
                        <div class="col-lg-6 form-group">
                            <label for="title"class="h4 form-label">Уникальное имя рецепта<span
                                    class="text-danger">*</span></label>
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="text"class="h4 form-label">Приготовление рецепта<span
                                class="text-danger">*</span></label>
                        <textarea class="form-control @error('text') is-invalid @enderror" name="text" rows="6 "
                            placeholder="Введите приготовление" required>{{ old('text') }}</textarea>
                        @error('text')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        <label for="ingredients" class="h4 form-label">Ингредиенты рецепта<span
                                class="text-danger">*</span></label>
                        <textarea class="form-control @error('ingredients') is-invalid @enderror" name="ingredients" rows="6 "
                            placeholder="Введите ингредиенты рецепта" required>{{ old('ingredients') }}</textarea>
                        @error('ingredients')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-outline-primary me-2">Сохранить рецепт
                        <i width="16" height="16" fill="currentColor" class="bi bi-pencil-square"
                            viewBox="0 0 16 16"> </i>
                    </button>
            </form>
        </div>
