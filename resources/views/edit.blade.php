...
@section('main_content')
    ...
    <div class="container">
        <div class="container text-left">
            <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('recipe.upd', ['id' => $recipe->id]) }}" id="image-upload">
                    ...
                    <div class="row justify-content-start">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <input type="text" id='title' name="title" value="{{ $recipe->title }}"
                                class="form-control @error('title') is-invalid @enderror" placeholder="Уникальное имя" required readonly
                                data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="***Имя изменить нельзя***">
                            @error('title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row justify-content-start">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <img id="preview-images" src="{{ asset($recipe->path) }}" alt="{{ $recipe->slug }}" alt="preview image" widht="300"
                                height="300" onError="this.src='../img/img_not_found.gif'; this.onerror=null">
